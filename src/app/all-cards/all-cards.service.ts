...
export class AllCardsService {
  ...
  getCards():Observable<any>{
    ...
    return this.http.get("http://flashcards-b.herokuapp.com/fc/cards/all")
  }

  add(card):Observable<any> {
    return this.http.post("http://flashcards-b.herokuapp.com/fc/cards/add",card)
    return this.http.post("http://localhost:8765/fc/cards/add",card)
  }

  put(card):Observable<any> {
    return this.http.put("http://flashcards-b.herokuapp.com/fc/cards/put",card)
